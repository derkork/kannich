...
## [0.6.0] - 2026-05-15
### Added
- ARM64 is now fully supported. The correct UV binary for the current architecture is automatically downloaded.
...
## [0.4.0] - 2026-03-06
### Changed
- `Uv` now supports the standardized `Tool` execution interface.

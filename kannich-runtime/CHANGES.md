...
## [0.10.0] - 2026-05-15
### Changed
- The `KANNICH_PROJECT_DIR` and `KANNICH_CACHE_DIR` environment variables are now consistently respected throughout the runtime. Previously some internal paths were still hardcoded to `/workspace` and `/kannich/cache`.
...
## [0.6.0] - 2026-02-20
### Added
- Update to match parent Kannich 0.6.0 project.
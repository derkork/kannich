...
## [0.6.0] - 2026-07-13
### Added
- The `quarkusNativeBuild` method now supports specifying a build profile.

## [0.5.0] - 2026-05-15
### Changed
- Updated to `kannich-parent` 0.10.0. ARM64 support is now available through the updated `kannich-maven` and `kannich-java` dependencies.
